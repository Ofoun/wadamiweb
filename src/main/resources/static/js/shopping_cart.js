...
function updateQuantity(productId, quantity) {
	...
	$.ajax({
		...
		showErrorModal("Erreur lors de la mise à jour de la quantité de produit.");
	});	
}
...
function removeProduct(link) {
	...
	$.ajax({
		...
		showModalDialog("Panier", response);
		
	}).fail(function() {
		showErrorModal("Erreur lors de la suppression du produit.");
	});				
}
